...
d_seq(1) = 0;
t_seq(1) = 1/beta * 0 + D_SS/Y_SS * (0 - pi_seq(1)) - d_seq(1);

for t = 2:T
    d_seq(t) = 0;
    t_seq(t) = 1/beta * d_seq(t-1) + D_SS/Y_SS * (i_seq(t-1) - pi_seq(t)) - d_seq(t);
end
...
t_seq(1) = tau_d * (1/beta * 0 + D_SS/Y_SS * (0 - pi_seq(1))) + tau_y * y_seq(1) + (1-tau_d) * tau_x_seq(1);
d_seq(1) = 1/beta * 0 - t_seq(1) + D_SS/Y_SS * (0 - pi_seq(1));
...
for t = H+1:T
    t_seq(t)     = tau_d * (1/beta * d_seq(t-1) + D_SS/Y_SS * (i_seq(t-1) - pi_seq(t))) + tau_y * y_seq(t) + (1-tau_d) * tau_x_seq(t);
    d_seq(t)     = 1/beta * d_seq(t-1) - t_seq(t) + D_SS/Y_SS * (i_seq(t-1) - pi_seq(t));
end
